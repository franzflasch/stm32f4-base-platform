...
#define USBD_VID                     0x4444
#define USBD_PID                     0x5710

#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      (uint8_t *)"STMicroelectronics"

#define USBD_PRODUCT_HS_STRING        (uint8_t *)"Test USB Device in HS Mode"
#define USBD_SERIALNUMBER_HS_STRING   (uint8_t *)"00000000011B"

#define USBD_PRODUCT_FS_STRING        (uint8_t *)"Test USB Device in FS Mode"
